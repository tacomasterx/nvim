...
-- asbjornhaland yank
kmap.set({ "n", "v", "x" }, "<leader>y", "\"+y", { desc = "Yanks to clipboard" })
kmap.set("n", "<leader>Y", "\"+Y", { desc = "Yanks content after cursor to clipboard" })
kmap.set({ "n", "v", "x" }, "<leader>d", "\"+d", { desc = "Cut to clipboard" })
...
kmap.set("t", "<C-ñ>", "<C-\\><C-n>", { desc = "Terminal escape to normal mode" })
...
kmap.set("n", "<C-w>y", "<C-w>v:terminal<CR>", { desc = "Open vertical terminal" })
